...
class AccountInvoice(models.Model):
    ...
    def _prepare_refund(self, invoice, date_invoice=None, date=None, description=None, journal_id=None):
        ...
        # Treat refund tax lines. They should match the incoice's, except for the data
        # directly coming from repartition_lines, which should be replaced by their
        # refund equivalent
        tax_rep_ln_mapping = {}
        for invoice_tax_entry in invoice.tax_line_ids:
            if not invoice_tax_entry.tax_repartition_line_id.tax_id in tax_rep_ln_mapping:
        ...
        for invoice_tax_entry in invoice.tax_line_ids:
            ...
            tax_line_vals.append({
                ...
                'account_id': ref_rep_ln.account_id.id,
